...
import { categories, formatPrice, products, store, type Product } from "@/data/mockData";

export const Route = createFileRoute("/$slug/")({
  head: () => ({
    meta: [
      { title: `${store.name} — Vitrine digital e pedidos no WhatsApp` },
      {
        name: "description",
        content: `${store.tagline} Monte seu pedido e envie direto pelo WhatsApp.`,
      },
      { property: "og:title", content: `${store.name} — Vitrine digital` },
  ...
  return (
    <div className="min-h-screen bg-background pb-28">
      <div className="mx-auto max-w-2xl">
          ...
          <div className="surface-card p-5">
            <div className="grid grid-cols-[auto_minmax(0,1fr)] items-center gap-4">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 line-clamp-2 text-sm text-muted-foreground">{store.tagline}</p>
              </div>
            </div>

            <div className="mt-4 flex flex-wrap items-center gap-2 text-sm">
              <Badge variant={store.isOpenNow ? "default" : "secondary"}>
            ...
            <div className="mt-4 grid gap-1 border-t border-border pt-4 text-xs text-muted-foreground">
        ...
        <div className="sticky top-0 z-20 mt-6 bg-background/95 px-5 py-3 backdrop-blur">
